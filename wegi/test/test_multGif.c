...
{
	{ .fname="/mmc/cloud.gif", .DirectFB_ON=false, .ImgAlpha_ON=true, .x0=-100, .y0=-80 }, /* 507x436 */
//	{ .fname="/mmc/runner.gif", .DirectFB_ON=false, .ImgAlpha_ON=false, .x0=-100, .y0=-80 },
//	{ .fname="/mmc/nian.gif", .DirectFB_ON=false, .ImgAlpha_ON=false, .x0=40,  .y0=240-60 }, /* 50x50 */
//	{ .fname="/mmc/3monk.gif", .DirectFB_ON=false, .ImgAlpha_ON=false, .x0=110, .y0=240-60 },/* 150x50 */
	{ .fname="/mmc/muyu.gif", .DirectFB_ON=false, .ImgAlpha_ON=true, .x0=90, .y0=80 }, //.x0=10, .y0=20  }, /* 140x123 */
};
