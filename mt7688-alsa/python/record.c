...
#define CHECK_AVERG            2400 //--threshold value of wave amplitude to trigger record
#define KEEP_AVERG               2200 //--threshold value of wave amplitude for keeping recording
#define DELAY_TIME              5 //seconds -- recording time after one trigger
#define MAX_RECORD_TIME  4 //seconds --max. record time in seconds
#define MIN_SAVE_TIME       2 //seconds --min. recording time for saving, short time recording will be discarded.

bool SAVE_WAVE_FILE = true; // save to .wav file
