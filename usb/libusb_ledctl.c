...
Function:
	Bluepill wiorks as a USB dongle, Widora-NEO transfer data to Bluepill to control 8 LEDs.
	VID&PID is the only identity for this APP, so two dongles with the same VID&PID will not work properly.
...
--------------------------------------------------------------------------------*/
 ...
 while(1)
 {
    ...
    //---- read from EP 1 IN, with value of ADC result  ---
