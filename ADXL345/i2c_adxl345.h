...
#ifndef __I2C__ADXL345__H
#define __I2C__ADXL345__H
...
uint8_t  I2C_Addr_ADXL345=0x53;//0x1d;//0x53;
...
void init_ADXL345(void)
{
   ...
   Single_Write_ADXL345(ADXL345REG_BW_RATE, 0x0A);//normaol operation,Output data rate 100Hz.
   Single_Write_ADXL345(ADXL345REG_POWER_CTL, 0x08);//measurement mode, no sleep
   Single_Write_ADXL345(ADXL345REG_INT_ENABLE, 0x00);//no interrupt
